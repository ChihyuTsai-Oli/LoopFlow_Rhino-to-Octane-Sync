...
3. Or download `loopflow-rhino-to-octanerender-sync-2.0.1-rh8_0-win.yak` from [Releases](https://github.com/ChihyuTsai-Oli/LoopFlow_Rhino-to-Octane-Sync/releases) and install from file.
