...
3. 或從 [Releases](https://github.com/ChihyuTsai-Oli/LoopFlow_Rhino-to-Octane-Sync/releases) 下載 `loopflow-rhino-to-octanerender-sync-2.0.2-rh8_0-win.yak`，在 Package Manager 選擇從檔案安裝
4. **完全關掉 Rhino 再開**
